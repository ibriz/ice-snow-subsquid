...
export type TransferBatch0Event = {
    operator: string;
    from: string;
    to: string;
...
export type TransferSingle0Event = [
    operator: string,
    from: string,
    to: string,
    id: ethers.BigNumber,
...
export type URI0Event = [value: string, id: ethers.BigNumber] & {
    value: string;
    id: ethers.BigNumber;
};
...
export type SafeBatchTransferFrom0Function = [
    from: string,
    to: string,
    ids: Array<ethers.BigNumber>,
    amounts: Array<ethers.BigNumber>,
    data: string
] & {
    from: string;
    to: string;
